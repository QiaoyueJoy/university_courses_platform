...
class Semester(models.Model):
    ...
    period = models.ForeignKey(Period, related_name='semester', on_delete=models.PROTECT)
...
class Section(models.Model):
    ...
    course = models.ForeignKey(Course, related_name='section', on_delete=models.PROTECT)
...
class Registration(models.Model):
    ...
    def __str__(self):
        return '%s - %s' % (self.section.__str__(), self.student.__str__())
